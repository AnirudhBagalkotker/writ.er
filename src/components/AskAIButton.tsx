...
function AskAIButton({ user }: Props) {
	...
	return (
		<Dialog open={open} onOpenChange={handleOnOpenChange}>
			...
			<DialogContent
				className="custom-scrollbar flex h-[85vh] min-w-[60vw] flex-col overflow-y-auto"
				ref={contentRef}>
				<DialogHeader>
					<DialogTitle>Ask Writ.AI about your Notes</DialogTitle>
					<DialogDescription>
						Writ.AI can answer any question you have about your
						notes
					</DialogDescription>
				</DialogHeader>
				...
				<div className="mt-4 flex flex-col gap-8">
					...
					{isPending && (
						<p className="animate-pulse text-sm">Thinkin...</p>
					)}
				</div>
				...
				<div
					...
					<Textarea
						ref={textareaRef}
						placeholder="Ask Writ.AI anything about your notes..."
